  ...
  return <section className="relative min-h-[600px] md:min-h-[700px] flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 sm:px-6 py-16 sm:py-20 md:py-28">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Text Content */}
          <motion.div className="max-w-2xl" initial="hidden" whileInView="visible" viewport={{
          once: true,
          amount: 0.3
        }} variants={staggerContainer}>
            <motion.div variants={scaleIn}>
              <Badge className="mb-3 px-4 py-1.5 text-sm font-medium w-fit bg-secondary text-white shadow-lg">
                → Focused on Hearing Health
              </Badge>
            </motion.div>
            
            <motion.p className="text-base sm:text-lg md:text-xl font-semibold mb-3 sm:mb-4 tracking-wide" style={{
            color: 'hsl(14, 85%, 54%)'
          ...
          <motion.div className="flex flex-col justify-center items-center mt-8 md:mt-0 px-4 pb-4 md:pb-12 overflow-visible" initial="hidden" whileInView="visible" viewport={{
          once: true,
          amount: 0.3
        }} variants={fadeInRight}>
            {/* Suspended Exploded View Product */}
            <motion.div className="relative z-20 pt-0 md:pt-8" style={{
            ...
            filter: 'drop-shadow(0 35px 70px rgba(0, 0, 0, 0.35)) drop-shadow(0 15px 40px rgba(0, 0, 0, 0.2)) drop-shadow(0 0 100px hsla(165, 70%, 45%, 0.3))'
              ...
              <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30" initial={{
              opacity: 0,
              scale: 0.8
            }} whileInView={{
              opacity: 1,
              ...
              <div className="absolute inset-0 -z-10 scale-125 opacity-40" style={{
              background: 'radial-gradient(ellipse at center, hsla(165, 70%, 45%, 0.5) 0%, hsla(165, 70%, 45%, 0.2) 40%, transparent 70%)',
              filter: 'blur(50px)'
            }} />
              <div className="absolute bottom-[-60px] left-1/2 -translate-x-1/2 w-[80%] h-[30px] -z-20 opacity-25" style={{
